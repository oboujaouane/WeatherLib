#
#  Be sure to run `pod spec lint WeatherLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "WeatherLib"
  s.version      = "0.0.1"
  s.summary      = "A CocoaPods library written in Swift to get weather forecast."
...
Get the current weather for a particular location and check out forecasts!
  ...
  s.homepage     = "https://github.com/oboujaouane/WeatherLib"
  ...
  s.author             = { "Ousama boujaouane" => "oboujaouane@gmail.com" }
